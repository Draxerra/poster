...
type PostProps = React.PropsWithChildren<Pick<Post, 'id' | 'likes'>>;

export default function PostListItem({ children, id, likes }: PostProps) {
  const [ optimisticLikes, updateLikesOptimistically ] = useOptimistic<number, number>(
    likes,
    (_state, updatedLikes) => updatedLikes,
  );
